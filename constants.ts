...
export const TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  apiKeySetupP2: { en: 'The problem is in your GitHub deployment settings file, not in the app code. To fix this, you must update your workflow file to securely provide the API Key during the build process.', ar: 'المشكلة تكمن في ملف إعدادات النشر على GitHub، وليس في كود التطبيق. لحل هذه المشكلة، يجب عليك تحديث ملف سير العمل (workflow) الخاص بك لتوفير مفتاح API بشكل آمن أثناء عملية البناء.' },
  ...
  apiKeySetupActionNote: { en: 'This will trigger a new deployment. Once it finishes, your app will be correctly configured.', ar: 'سيؤدي هذا إلى بدء عملية نشر جديدة. بمجرد انتهائها، سيتم تكوين تطبيقك بشكل صحيح.'},
};
